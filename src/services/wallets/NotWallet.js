...
class NotWallet extends WalletBase {
    constructor(userId) {
        super();
        ...
        this.apiEndpoint = "https://notapi.io/v2";
        this.db = pgPool;
        this.userId = userId;
        this.coinId = null;
    }
    ...
    async withdraw(recipientAddress, amount) {
        ...
        console.log("Осуществлен вывод с NOT:", transaction);
        return transaction;
    }
    ...
    async deposit(amount) {
        try {
            ...
            const notCoin = coins.find(coin => coin.symbol === "NOT");
            if (!notCoin) {
                throw new Error('NOT coin not found in coins array');
            }
            this.coinId = notCoin.id;
